...
reveal more patterns? dual axis bar chart for revenue vs customers vs month-to-month % change.

-   rate

-   percentage change

-   revenue per customer plot against revenue

Clarity of the message??

excessive grouping resulted in lower clarity.

Add texture to the bar chart differentiate age group

percentage point != percent

plot title - subject + details

Example of title :

**Figure 1-1(b) Summarised Data**

Example of axis-label
