...
```{r}
#| code-fold: false
pacman::p_load(readxl, ggHoriPlot, ggthemes, tidyverse, data.table)
```
...
#### 3.3.4.3 Derive variables

```{r}
trades <- trades %>%
  mutate(balance = export-import) %>%
  mutate(rate = round(
    (balance/shift(balance))-1,
    digits = 2))
```

### 3.3.5 Extract countries

#### 3.3.5.1 Countries with trade balance 
...
#### 3.3.5.2 Countries with zero-export by Singapore
...
ggplot() + 
  ...
  scale_x_date(expand = c(0,0), 
               ...
               limit = c(as.Date("2020-01-01"),
                         as.Date("2022-12-31"))) +
  labs (x = "Period") +
  ggtitle("Singapore Trade Balance with N Countries from year 2020 to 2022") +
  ...
  geom_vline(xintercept = as.Date("2022-03-01"), color = "red", size = 1) +
...
Singapore's largest construction fair. The most modern solutions in the field of building materials, construction technology as well as interior finishings and interior design are presented here.
...
Architecture & Building Services (ABS) encompasses seven physical exhibitions will take place at the Marina Bay Sands Singapore Expo from 16 - 18 November, together with all 10 major conferences over the three days. Exhibitors are able to discover the procurement needs of more than 10,000 trade visitors and professionals from 7 synergistic trade shows all under one roof on the same dates. Archit\...
...
Being reputed as the 'Glass Hub of Southeast Asia', this unparalleled glass exhibition provides regional industry players a deeper insight to the glass manufacturing, processing, products and materials sectors. It is therefore an excellent platform for industry players across the globe to step foot and tap into the growing market of Southeast Asia. This event is supported under International Mark\...

+------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [**\                                                                         | [7.6 quake 78 km northwest of Lae, Morobe Province, Papua New Guinea, Sep 11, 2022 9:46 am (GMT +10)](https://www.volcanodiscovery.com/earthquakes/7019421/2022-09-10/23h46/magnitude7-Papua-New-Guinea.html) |
| Papua New Guinea**](https://www.volcanodiscovery.com/earthquakes/papua.html) |                                                                                                                                                                                                               |
+==============================================================================+===============================================================================================================================================================================================================+
+------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

+---------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| [**\                                                                | [7.7 quake North Pacific Ocean, 99 km southeast of Tecoman, Colima, Mexico, Sep 19, 2022 1:05 pm (GMT -5)](https://www.volcanodiscovery.com/earthquakes/7040170/2022-09-19/18h05/magnitude7-Mexico.html) |
| Mexico**](https://www.volcanodiscovery.com/earthquakes/mexico.html) |                                                                                                                                                                                                          |
+=====================================================================+==========================================================================================================================================================================================================+
+---------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

https://www.volcanodiscovery.com/largest-recent-by-country/earthquakes/archive/2022.html

|  5  | [**Peru**](https://www.volcanodiscovery.com/earthquakes/peru.html) | [7.2 quake 30 km east of Ayaviri, Puno, Peru, May 26, 2022 7:02 am (GMT -5)](https://www.volcanodiscovery.com/earthquakes/6821838/2022-05-26/12h02/magnitude7-Ecuador.html) |
|:---:|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

<br>

**2022-09-05 to 08 :** Food and Beverage, HORECA Fairs[^3]

[^3]: MakeYourAsia. 2022. Trade Fairs in Singapore. https://makeyourasia.com/trade-fairs/trade-fairs-singapore.html

The largest food industry and HORECA fairs in Singapore. Due to the great interest from both exhibitors and visitors, since 2021, it is organized at two exhibition centers: Singapore Expo and Suntec City.

**DATES:** 05-08/09/2022

**INDUSTRY:** Energy, gas

The fair, coorganized with a series of gas industry conferences, focusing in particular on production and transmission technologies, as well as the application of natural gas, LNG and alternative energy sources. One of the most important world events in the gas industry.

### [**COMEX SHOW**](https://www.comexitshow.com.sg/)
...
The fair is organized offline and online. The latest electronic devices are presented there: Laptops, telephones, accessories, etc. The presentations are combined with promotions. A great opportunity to reach out to potential retail customers.

### [June 2022 Afghanistan earthquake](https://en.wikipedia.org/wiki/June_2022_Afghanistan_earthquake)
...
[Wikipediahttps://en.wikipedia.org › wiki › June_2022_Afghanis\...](https://en.wikipedia.org/wiki/June_2022_Afghanistan_earthquake)

A 4.0-kilometre (2.5 mi) deep ***earthquake*** measuring magnitude (Mw ) 6.2 struck southeastern ***Afghanistan*** on 22 June ***2022*** at 01:24:36 AFT (on 21 June ***2022*** at \...

### [2022 Pakistan floods](https://en.wikipedia.org/wiki/2022_Pakistan_floods)

[![](data:image/png;base64,){alt=""}](https://en.wikipedia.org/wiki/2022_Pakistan_floods)

[Wikipediahttps://en.wikipedia.org › wiki › 2022_Pakistan_floods](https://en.wikipedia.org/wiki/2022_Pakistan_floods)

From 14 June to October ***2022***, ***floods*** in ***Pakistan*** killed 1,739 people, and caused ₨ 3.2 trillion (\$14.9 billion) of damage and ₨ 3.3 trillion (\$15.2 billion) \...
...
### [Milipol Asia-Pacific 2022](https://web.micepad.co/milipol-asia-pacific-2022)

Enterprise Singapore (LEAD)

Singapore

MILIPOL Asia-Pacific 2021 Asia Pacific\'s Largest Homeland Security event receives official support from the Ministry of Home Affairs, Singapore and the Ministry of the Interior of France. Milipol Asia-Pacific 2021 continues to serve the ASEAN Region and retain its 3-day format showcasing the latest technology solutions in the Defence and Security environment. The Show will address the fundamenta\...

<br>

**2022-04-26 : Singapore Disease Outbreak Response System Condition (DORSCON) Orange to Yellow**[^4]
...
**2022-03-24** **: Singapore Easing Community SMMs and Border Measures**

Singapore Tasks Force eased the community Safe Management Measures (SMM) and border measures.

16 MAR 2022-18 MAR 2022

### [Asia Pacific Maritime 2022](https://web.micepad.co/asia-pacific-maritime-2022)

Enterprise Singapore

https://www.enterprisesg.gov.sg/events/lead-trade-fairs-and-business-missions?year=2022

Singapore

APM is a one-stop market for the region\'s maritime community, showcasing the latest in marine, workboat & offshore engineering and port technology. It offers a holistic business experience by combining exhibition, conferences and seminars. In 2018, some 1,432 exhibiting companies from over 60 countries occupied more than 21,000 sqm of exhibition space. The exhibition was attended by 14,158 visitor\...

<br>

**2022-02-24** **: Russia invade Ukraine**
...
### [SEMICON Southeast Asia 2021](https://web.micepad.co/semicon-southeast-asia-2021)
