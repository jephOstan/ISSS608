...
Visualise trading performances for import and export with other ASEAN members.
...
## 4.6 Visualise Import & Export by Individual Country
...
ggplot(data = germany,
       aes (x = period,
            y = tradeVolume)) +
  geom_line(aes
            (color = tradeType, linetype = tradeType)) +
