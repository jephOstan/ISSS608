...
::: {.callout-warning appearance="simple" icon="false"}
Step1 - Click "**File**" from the Tableau Desktop main menu and select "**Open**" from the drop-down options.
...
Don't panic, click "**Data Source**" at the bottom left corner. Once landed on the homepage, can perform step-1.

![Figure 2.2](images/image-987662873.png){fig-alt="Click on \"Data Source\" to direct the user to the homepage if the user landed on different page." width="400"}
:::
