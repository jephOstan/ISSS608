...
::: {.callout-warning appearance="simple" icon="false"}
[![Figure 2.15](images/image-564342359.png){fig-alt="Add population count for each gender to add context of gender differences to the population pyramid."}](https://public.tableau.com/views/SingaporePopulationPyramindJun2022v1_2/Dashboard2?:language=en-US&publish=yes&:display_count=n&:origin=viz_share_link)
:::
...
Can only derive descriptive analysis by itself.

Combine with Other Chart

Add more context and more effective visual analysis.
:::
