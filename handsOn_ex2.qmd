...
This theme provides more [arguments](https://www.rdocumentation.org/packages/ggthemes/versions/3.5.0/topics/theme_pander) than other themes for users to adjust the plot.
