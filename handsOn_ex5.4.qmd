...
subtitle: "Hands-on Exercise 5.4 : Visual Multivariate Analysis"
editor: visual
date:  11 Feb 2023
...
[***read_csv( )*** - readr -]{style="color:#d46e15"} to read CSV file name **WHData-2018.csv** into a tibble data frame object called *wh*.
